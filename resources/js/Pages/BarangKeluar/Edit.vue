<template>
    ...
    <form @submit.prevent="form.put(route('item-out.update', props.itemOut.id))">
...
const form = useForm({
    'out_date': props.itemOut.out_date,
    'out_quantity': props.itemOut.out_quantity,
    'item_id': props.itemOut.item_id,
})
</script>
